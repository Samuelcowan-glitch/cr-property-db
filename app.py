...
def _migrate_listings_table_columns():
    ...
    with app.app_context():
        ...
        new_cols = [
            ...
            ('total_size',           'REAL'),
            ('self_contained',       'BOOLEAN DEFAULT 0'),
            ('add_on_factor',        'REAL'),
            ('build_status',         'TEXT'),
            ('set_as_to_let',        'BOOLEAN DEFAULT 1'),
            ('lease_type',           'TEXT'),
            ('rent_qualifier',       'TEXT'),
            ('rent_inclusive',       'TEXT'),
            ('rent_from',            'REAL'),
            ...
            ('possession_now',       'BOOLEAN DEFAULT 0'),
            ...
            ('set_as_for_sale',      'BOOLEAN DEFAULT 0'),
            ('sale_price',           'REAL'),
            ('sale_price_display',   'TEXT'),
            ('service_charge',       'REAL'),
            ('service_charge_na',    'BOOLEAN DEFAULT 0'),
            ('service_charge_comment','TEXT'),
            ('rateable_value',       'REAL'),
            ('rateable_value_na',    'BOOLEAN DEFAULT 0'),
            ...
            ('parking_ratio',        'TEXT'),
            ('parking_rent',         'REAL'),
            ('parking_rent_na',      'BOOLEAN DEFAULT 0'),
