...
from app import (app, db, _migrate_project_columns, _migrate_listing_columns,
                 ...
                 _migrate_crm_columns, _migrate_rates_tables, _migrate_progression_columns, _migrate_contact_roles, _migrate_retire_client, _migrate_transaction_kinds, _sync_model_columns, _migrate_security_columns, _migrate_diary_tables, _ensure_default_user, _seed_project_listings,
